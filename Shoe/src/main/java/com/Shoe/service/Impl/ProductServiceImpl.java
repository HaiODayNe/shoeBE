...
//
//    @Override
//    public ResponseEntity<Product> getProduct(String productCode, Long userId) {
////        Optional<Product> productFound = productRepository.findByProductCode(productCode);
...
//
//    @Override
//    public ResponseEntity<Product> addProduct(ProductCreateRequest productCreateRequest) {
